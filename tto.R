...
# **2.** *Analizar la data de los fallecidos por covid en 
#         regiones escogidas a su criterio.*
...
# 2.2. Describir lo que se est ??a evaluando en pocas palabras.

summary(espe$DEPARTAMENTO)
